    ...
    def send_message(self, receiver_names, content, group_names=None):
        ...
        try:
            ...
            if group_names:
                ...
                if receiver_names and any(receiver_names):
                    for receiver_name in receiver_names:
                        remarkName = itchat.search_friends(remarkName=receiver_name)
                        if remarkName:
                            self.send_msg(media_type, content, remarkName[0].UserName)
